...
def dr14_spec_confirmed_quasar():
    # spectroscopic confirmed quasar is sdss dr14
    confirmed_quasar_ID = read_ID_file('./data/ID_QSO')
    return confirmed_quasar_ID

def dr14_pho_confirmed_star():
    # photometric confirmed star is sdss dr14
    confirmed_star_ID = read_ID_file('./data/ID_Star')
    return confirmed_star_ID
...
def load_data_mode_2(line, dr14_confirmed_star_ID, dr14_confirmed_quasar_ID, 
...
def load_data(infile, outfile1, outfile2, outfile3, mode):
    ...
    dr14_confirmed_star_ID = dr14_pho_confirmed_star()
        ...
        with open(infile) as f:
            ...
            for line in lines[1:]:
                ...
                if mode is 0: 
                    ...
                    # match with dr14
                    quasar_num, nquasar_num, other_num = \
                         load_data_mode_2(line, dr14_confirmed_star_ID, dr14_confirmed_quasar_ID, 
                                    outfile1, outfile2, outfile3, quasar_num, nquasar_num, other_num)
        return quasar_num, nquasar_num, other_num
